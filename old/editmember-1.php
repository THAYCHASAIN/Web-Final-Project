                ...
                <h1 class="	fa fa-user fa-3x" style = "font-weight: bold; text-align: left; margin-left:5%; " > ข้อมูลผู้ใช้บริการห้องสมุด</h1>
                    ...
                    <div class="col-sm-1"></div>
                        <div class="col-sm-4"style =" text-align: center;" >
                             <img src="assets/img/member-1.jpg" style="width: 80%;"/>   
                        </div>
                        <div class="col-sm-6" >
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label class="control-label col-sm-4">รหัสนิสิต:</label>
                                    <label class="control-label col-sm-2" >57021252</label>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4" >ชื่อ:</label>
                                    <div class="col-sm-8"> 
                                         <input type="text" class="form-control" id="name" placeholder="เตชเสน ชิณพงษ์">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4" >เบอร์ติดต่อ:</label>
                                    <div class="col-sm-8"> 
                                         <input type="text" class="form-control" id="tel" placeholder="095-4464537">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-4" >Email:</label>
                                    <div class="col-sm-8"> 
                                         <input type="text" class="form-control" id="email" placeholder="thaychasain@hotmail.com">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row" style = "text-align: center;" >
                                    <a  href="editmember.php"> <button type="button" class="btn btn-primary " s >บันทึกข้อมูล</button> </a>
                                </div>
                            </form>  
