            ...
            <div id="page-inner">
                ...
                <div class="row"style ="margin-top: 10%;">
                    ...
                    <div class="col-sm-4"style =" text-align: center;" >
                        <img src="assets/img/user.png" style="width: 80%;"/>    
                    </div>
                    <div class="col-sm-6" >
                        <form class="form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-sm-4" >username:</label>
                                <label class="control-label col-sm-2" >12345678</label>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-4" >ชื่อ:</label>
                                <div class="col-sm-8"> 
                                    <input type="text" class="form-control" id="name" placeholder="mint preeya">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-4" >เบอร์ติดต่อ:</label>
                                <div class="col-sm-8"> 
                                    <input type="text" class="form-control" id="tel" placeholder="091-8371213">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-4" >Email:</label>
                                <div class="col-sm-8"> 
                                    <input type="text" class="form-control" id="email" placeholder="preeya.mint23@hotmail.com">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row" style = "text-align: center;" >
                                <a  href="editadmin.php"> <button type="button" class="btn btn-primary " s >บันทึกข้อมูล</button> </a>
                            </div>
                        </form>    
                        </div>
                    </div>
