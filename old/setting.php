...
<body >
    <div id="wrapper" >
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li >
                        <a  class = "active-menu"  href="setting.php"><i class="fa fa-cog fa-2x"></i> ตั้งค่า</a>
                    </li>
                </ul>
            </div>
        </nav>  
        ...
        <div id="page-wrapper" style=" background-image: url('assets/img/bg.jpg');"  >
            ...
            <div id="page-inner" >
            <div class="row">
                <h1 class="	fa fa-gear fa-3x" style = "font-weight: bold; text-align: left; margin-left:5%; " > ตั้งค่า</h1>
            </div> 
