           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="editmember.php"><i class="fa fa-user fa-2x"></i> ข้อมูลผู้ใช้บริการห้องสมุด</a>
                    </li>          
                     <li>
                        <a  href="returnbook.php" ><i class="fa fa-book fa-2x"></i> คืนหนังสือ</a>
                    </li>
                    <li>
                        <a href="#"><i class="glyphicon glyphicon-book fa-2x"></i> หนังสือ<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                             <li>
                                <a href="book.php">รายการหนังสือ</a>
                            </li>
                            <li>
                                <a href="addbook.php">เพิ่มหนังสือ</a>
                            </li>
                        </ul>
                    </li>    
                    <li >
                        <a  href="history.php"><i class="glyphicon glyphicon-list-alt fa-2x"></i> ประวัติการยืมหนังสือ</a>
                    </li>	
                    <li>
                        <a href="#"><i class="	fa fa-pie-chart fa-2x"></i> สถิติการยืมหนังสือ<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
